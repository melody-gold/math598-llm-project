...
>> missing what went well and what did not, how long training took, size of dataset  
...
>> add more challenges with actual model implementation and how overcame the incompatible dimension size error. 
